  ...
  return (
    ...
    >
      ...
      <nav>
        ...
        >
          <li>
            <a href="/unknown/home" style={navLinkStyle}>
              <i className="fas fa-home"></i> Home
            </a>
          </li>
          <li>
            <a href="/unknown/about" style={navLinkStyle}>
              <i className="fas fa-info-circle"></i> About Us
            </a>
          </li>
          <li>
            <a href="/unknown/contact" style={navLinkStyle}>
              <i className="fas fa-envelope"></i> Contact Us
            </a>
          </li>
          <li>
            <a href="/unknown/Properties" style={navLinkStyle}>
              <i className="fa-solid fa-building"></i> Properties
            </a>
          </li>
          <li>
            <a href="/unknown/booking" style={navLinkStyle}>
